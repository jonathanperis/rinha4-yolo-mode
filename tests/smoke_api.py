...
# readable. Every case follows the same payload-derived heuristic path; tests
# must not rely on exact preview/test-payload IDs.
CASES = [
    (
        b'{"id":"tx-low","transaction":{"amount":10,"installments":1},"customer":{"tx_count_24h":0},"terminal":{"is_online":false,"card_present":true}}',
        b'{"approved":true,"fraud_score":0.0}',
    ),
    (
        b'{"id":"tx-medium","transaction":{"amount":100,"installments":1},"customer":{"tx_count_24h":10},"terminal":{"is_online":false,"card_present":true}}',
